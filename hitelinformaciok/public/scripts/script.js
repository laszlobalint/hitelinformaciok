...
(function () {
  ...
  $(function () {
    ...
    function parallaxScroll() {
      ...
      o = ((innerHeight - offsetTop * 0.7) / innerHeight).toFixed(2);
    ...
    if (plugins.bootstrapTabs.length) {
      ...
      for (i = 0; i < plugins.bootstrapTabs.length; i++) {
        ...
        bootstrapTabsItem.find('.nav-tabs').on(
          'click',
          'a',
          (function (isURLTabs, currentHash) {
        ...
        tabsNav.on(
          ...
          (function (bootstrapTabsItem) {
            return function (e) {
              ...
              e.stopPropagation();
              bootstrapTabsItem
                .find("a[href$='" + $(this).attr('href').split('#').pop() + "']")
                .first()
                .trigger('click');
            };
          })(bootstrapTabsItem),
    ...
    if (plugins.rdNavbar.length) {
      plugins.rdNavbar.RDNavbar({
        ...
        autoHeight: false,
        stickUpClone:
          plugins.rdNavbar.attr('data-stick-up-clone') && !isNoviBuilder ? plugins.rdNavbar.attr('data-stick-up-clone') === 'true' : false,
        responsive: {
          0: {
                ...
                $.ajax({
                  ...
                  if (responceCode !== 'CPT000') {
                    if (output.hasClass('snackbars')) {
                      output.html(
                        '<p><span class="icon text-middle mdi mdi-check icon-xxs"></span><span>' + captchaMsg[responceCode] + '</span></p>',
                      );
        ...
        filterItems
          .on('click', function (e) {
            ...
            iso.isotope({
              ...
              filter:
                this.getAttribute('data-isotope-filter') == '*' ? '*' : '[data-filter*="' + this.getAttribute('data-isotope-filter') + '"]',
    ...
    function initMaps() {
      ...
      $.getScript(
        '//maps.google.com/maps/api/js?' + (key ? 'key=' + key + '&' : '') + 'sensor=false&libraries=geometry,places&v=quarterly',
        function () {
          ...
          for (var i = 0; i < plugins.maps.length; i++) {
            ...
            if (markerItems.length) {
              ...
              for (var j = 0; j < markerItems.length; j++) {
                ...
                getLatLngObject(markerElement.getAttribute('data-location'), markerElement, plugins.maps[i], function (
                  location,
                  markerElement,
                  mapElement,
                ) {
    ...
    if (plugins.parallaxTextBody.length) {
      ...
      var zInner, o, heightParLayer, innerHeight, offsetTop;
