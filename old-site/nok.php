    ...
    <section class="mini-spacer feature24">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7 text-center">
          ...
          <h2 class="title">NOK</h2>
          <h6 class="subtitle">Az előtakarékoskodásban gondolkodók számára nyújt segítséget.</h6>
        </div>
      </div> 

      <!-- KALKULÁTOR -->  
      <div class="container">
          <iframe src="<?php echo $nurl;?>" width="100%" class="iframe-to-resize" frameborder="0"></iframe>
      </div>
      <!-- KALKULÁTOR VÉGE -->  
