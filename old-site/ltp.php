    ...
    <section class="mini-spacer feature24">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7 text-center">
          ...
          <h2 class="title">LTP</h2>
          <h6 class="subtitle">A biztonságos megtakarítást kedvelőknek lakáscéljuk eléréséhez.</h6>
        </div>
      </div> 

      <!-- KALKULÁTOR -->  
      <div class="container">
          <iframe src="<?php echo $lurl;?>" width="100%" frameborder="0"></iframe>
      </div>
      <!-- KALKULÁTOR VÉGE -->  
