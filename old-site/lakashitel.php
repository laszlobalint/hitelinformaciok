    ...
    <section class="mini-spacer feature24">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7 text-center">
          ...
          <h2 class="title">Lakáshitel kalkulátor</h2>
          <h6 class="subtitle">Számold ki a banki ajánlatok közül a legkedvezőbb törlesztőrészletet használt, vagy új lakás vásárlásához, esetleg korszerűsítéshez!</h6>
        </div>
      </div> 
