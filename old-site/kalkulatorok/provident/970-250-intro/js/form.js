...
form.init = function() {
        //form.valid = false;
        form.values = {};
        form.values.issuevalue = 40000;//RGB-2019-4
        ...
        form.values.period = 12;  //RGB-2019-4
...
form.calculateHs = function() {
        ...
        switch (form.values.period) {
            ...
            case 12:
                return form.values.issuevalue * 0.198;
                break;
...
form.calculatePp = function() {
        ...
        switch (form.values.period) {
            ...
            case 12:
                return form.values.issuevalue * 0.06;
                break;
...
form.calculateInterest = function() {
        ...
        switch (form.values.period) {
            ...
            case 12:
                return form.values.issuevalue * 0.0085;
                break;
...
form.caluclateSubmitLink = function() {
        ...
        var urlStart = "&";
        if (params.clickTag.indexOf("?") == -1) {
            urlStart = "/?"
        }
        var submitlink = urlStart + "utm_period=" + form.values.period;
        var producType = "MT";
        if (form.values.ifhs == true) {
            producType = "HS";
        }
        ...
        var protectionpackage = "";
        if (form.values.ifpp == true) {
            protectionpackage = "I";
        }
        //if (form.values.ifpp == true) {
            submitlink += "&utm_package=" + protectionpackage;

       // }

        //  submitlink += "&utm_source=gemius&utm_medium=jofogas_300x250&utm_campaign=pm_december";
