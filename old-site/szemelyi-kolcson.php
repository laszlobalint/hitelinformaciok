...
<body>
  ...
  <?php
            ...
            $csurl = Hitel::getCalculatorURL(
                19,             // felhasználó azonosító
                500000,       // ingatlan vétel ár
                60,            // futamidő
                9,              // hitelcél
                false,
                ...
                'personal_loan'              //personal_loan kalkulátor az 2-es típusú
            );
    ...
    <section class="mini-spacer feature24">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7 text-center">
          ...
          <h2 class="title">Személyi kölcsön</h2>
          <h6 class="subtitle">Szabadon felhasználható bármilyen célra!</h6>
        </div>
      </div> 

      <!-- KALKULÁTOR -->  
      <div class="container">
          <iframe src="<?php echo $csurl;?>" width="100%" class="iframe-to-resize" frameborder="0"></iframe>
      </div>
      <!-- KALKULÁTOR VÉGE -->  
